...
import { View, Text, TouchableHighlight, TouchableOpacity, Image, FlatList, StatusBar, ScrollView, Dimensions } from 'react-native';
...
export default function Profile() {
  ...
  const [wallet, setWallet] = useState([
    ...
    { key: '3', name: 'Investimento Itaú', value: -15 },
  ]);
